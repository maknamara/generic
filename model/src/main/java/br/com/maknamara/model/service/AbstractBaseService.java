...
public class AbstractBaseService<T extends BaseEntity, D extends GenericDAO<T>, V extends BaseValidator<T>> implements BaseService<T> {
    protected D dao;
    protected V validator;

    public AbstractBaseService(@NonNull D dao, @NonNull V validator) {
        this.dao = dao;
